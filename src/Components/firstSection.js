                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-7 col-sm-12 mainDetails">
                            ...
                            <div className="mainContents ps-xl-2 ps-0">
                                ...
                                <h1 className=" myName text-xl-start text-center fw-bolder"> Praveen</h1>
                                ...
                                <p className="developerTagline text-xl-start text-center">Passionate Web Developer based in <br /> Kumbakonam, India.</p>
                            </div>
